...
| Revisi | Deskripsi |
| :--- | :--- |
| *A* | *Penambahan KF13 dan perubahan penjelasan untuk KF03, KF04, KF05, KF09, dan KF11* |
| *B* |  |
| *C* |  |
| ... |  |
...
| *UC09* | *Menukarkan Poin dengan Reward* | *Masyarakat menukarkan poin yang dimiliki dengan reward yang dipilihnya* | *Masyarakat* | *KF11, KF12* |

## 3.3 Use Case Diagram
<br>
<p align="center">
<img alt="Contoh Activity Diagram" src="./assets/diagram/UseCaseDiagram.svg" width="70%">
</p>
<p align="center">

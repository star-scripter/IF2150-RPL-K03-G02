...
| :--- | :--- | :--- | :--- |
| | *FormLaporan* | *Menyediakan tampilan serta fungsionalitas formulir input untuk laporan (baik CleanIt maupun ReportIt) bagi pengguna masyarakat* | *UC01, UC05* |
| | *Laporan* | *Menyimpan informasi yang berada di laporan yang telah dikirim oleh pengguna masyarakat, yaitu bukti, lokasi, waktu, keterangan* | *UC01, UC03, UC05, UC06* |
| | *Media* | *Menyediakan kemampuan pengambilan bukti (foto/video) yang akan dicantumkan dalam laporan* | *UC01, UC02, UC05* |
| | *DaftarLaporan* | *Menyimpan dan menampilkan daftar submisi laporan* | *UC01, UC03, UC05, UC06* |
| | *ValidatorLaporan* | *Menyediakan kemampuan bagi operator untuk mengubah status validitas sebuah laporan dan memetakan lokasi pencemaran* | *UC03, UC06* |
| | *Lokasi* | *Menyimpan informasi posisi pencemaran pada daftar lokasi* | *UC03* |
| | *DaftarLokasi* | *Menyimpan dan menampilkan daftar lokasi pencemaran* | *UC03, UC04, UC06* |
| | *Pengguna* | *Menyimpan informasi terkait poin yang dimiliki* | *UC07, UC09* |
| | *Reward* | *Menyimpan informasi terkait jenis, jumlah, dan harga reward itu sendiri* | *UC09* |
| | *DaftarReward* | *Menyimpan dan menampilkan daftar reward yang tersedia* | *UC08, UC09* |
| | *ManagerPoin* | *Mengatur perhitungan poin dalam transaksi reward* | *UC09* |

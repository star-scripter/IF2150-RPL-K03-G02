...
classDiagram
    ...
    FormLaporan --|> Laporan : kirimLaporan()
...
| :--- | :--- | :--- | :--- |
| *C01* | *FormLaporan* | *lokasi, waktu, idMedia, typeMedia, sumber* | *buatLaporan(), editLaporan(), kirimLaporan()* |
| *C02* | *Laporan* | *lokasi, waktu, idMedia, typeMedia, sumber* | *tampilkanLaporan* |
| *C03* | *Media* | *idMedia, typeMedia* | *tampilkanMedia(), inputMedia()* |
...
| ID Kelas | Nama Kelas | Atribut | Metode/Operasi |
| :--- | :--- | :--- | :--- |
| *C01* | *FormLaporan* | *lokasi, waktu, idMedia, typeMedia, sumber* | *buatLaporan(), editLaporan()* |
...
classDiagram
    ...
    <<UserInterfacer>> ValidatorLaporan
    <<Structurer>> DaftarLaporan
    ...
    ValidatorLaporan --> DaftarLokasi : memetakan
    DaftarLokasi  o-- Lokasi : memuat
    DaftarLaporan  o-- Laporan : memuat
```
</p>
<p align="center">
...
| *C06* | *Lokasi* | *lokasi* | *tampilkanLokasi() |
...
| ID Kelas | Nama Kelas | Atribut | Metode/Operasi |
| :--- | :--- | :--- | :--- |
| *C01* | *FormLaporan* | *-* | *buatLaporan()* |
| *C03* | *Media* | *-* | *inputMedia()* |
...
| *C04* | *DaftarLaporan* | *Menyimpan dan menampilkan daftar submisi laporan* |
| *C05* | *ValidatorLaporan* | *Menyediakan kemampuan bagi operator untuk mengubah status validitas sebuah laporan dan memetakan lokasi pencemaran* |
| *C12* | *ManagerPoin* | *Mengatur perhitungan poin dalam transaksi reward* |

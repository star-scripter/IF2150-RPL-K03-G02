...
|  | *A01* | *Business* | *Fitur ReportIt dan CleanIt hanya dapat diakses oleh user yang memiliki akun terdaftar dan telah melakukan autentikasi dan verifikasi* | *Ya* |
|  | *A01* | *System* | *Sistem menyimpan kredensial pengguna di database. Kredensial disimpan dengan password yang dihash dengan bcrypt.* | *Ya* |
|  | *A02* | *User* | *Pengguna (masyarakat) dapat melaporkan suatu lokasi yang dianggap terkontaminasi oleh sampah domestik kepada operator* | *Ya* |
|  | *A02* | *Business* | *Setiap laporan ReportIt yang dikirimkan oleh pengguna harus memuat informasi seperti lokasi dan bukti pencemaran sebelum dapat diajukan untuk proses validasi dari operator* | *Ya* |
|  | *A02* | *System* | *Sistem menyimpan informasi koordinat lokasi pencemaran di database dan foto/video bukti  laporan di object storage* | *Ya* |
|  | *A03* | *User* | *Pengguna (operator) dapat menerima atau menolak permintaan terkait pemetaan lokasi terkontaminasi serta me-request sistem untuk menampilkan daerah terkontaminasi jika valid* | *Ya* |
|  | *A03* | *Business* | *Setiap laporan ReportIt yang dikirimkan oleh pengguna harus diverifikasi dan dicek validitasnya oleh operator sebelum memberikan reward* | *Ya* |
|  | *A04* | *User* | *Pengguna (masyarakat) dapat memilih lokasi yang terkonfirmasi terkontaminasi sampah* | *Ya* |
|  | *A04* | *Business* | *Lokasi untuk kegiatan CleanIt harus dapat diakses oleh masyarakat untuk melakukan pembersihan* | *Tidak* |
|  | *A05* | *User* | *Pengguna (masyarakat) dapat mengirimkan laporan beserta bukti pembersihan daerah terkontaminasi sampah pada sistem* | *Ya* |
|  | *A05* | *Business* | *Setiap penyelesaian bounty CleanIt harus disertai bukti dokumentasi kegiatan pembersihan* | *Ya* |
|  | *A05* | *System* | *Sistem menyimpan foto/video bukti dokumentasi di object storage* | *Ya* |
|  | *A06* | *User* | *Pengguna (operator) dapat menetapkan validitas laporan pembersihan daerah terkontaminasi sampah* | *Ya* |
|  | *A06* | *Business* | *Bukti penyelesaian CleanIt harus diverifikasi oleh operator sebelum kegiatan dinyatakan selesai dan memberikan reward ke pengguna* | *Ya* |
|  | *A07* | *User* | *Pengguna (masyarakat) mendapatkan poin reward beserta notifikasinya* | *Ya* |
| | *A07* | *User* | *Penggguna (masyarakat) dapat menukarkan poin dengan reward* | *Ya* |
|  | *A07* | *Business* | *Pengguna hanya memperoleh poin setelah kegiatan CleanIt dinyatakan valid oleh operator, kegiatan yang tidak valid tidak akan menerima reward* | *Ya* |

...
| :--- | :--- | :--- | :--- |
| KNF01 | R03 | *Security* | *Sistem harus meng-hash kata sandi pengguna menggunakan algoritma bcrypt (cost factor minimal 10) sebelum menyimpannya ke database, dan tidak boleh menyimpan kata sandi dalam bentuk plain-text.* |
...
| KNF03 | R07 | *Response time* | *Ketika operator membuka antarmuka daftar laporan yang menunggu verifikasi, sistem harus menampilkan seluruh laporan dalam waktu maksimal 2 detik meskipun jumlah laporan tertunda mencapai ratusan.* |
...
| KNF05 | R01 | *Portability* | *Sistem harus dapat diakses dan berfungsi dengan baik melalui peramban (browser) pada perangkat desktop maupun mobile tanpa memerlukan instalasi tambahan.* |

...
| *KF02* | *R01* | *Perangkat lunak memiliki kemampuan untuk mengauntentikasi dan verifikasi proses log in pengguna* |
| *KF03* | *R03* | *Perangkat lunak dapat menampilkan antarmuka pembuatan laporan setelah pengguna memilih fitur ReportIt* |
| *KF04* | *R05* | *Perangkat lunak dapat mengecek kelengkapan laporan sebelum mengirimkannya ke database server* |
| *KF05* | *R08* | *Perangkat lunak dapat menampilkan antarmuka daftar laporan pada database sehingga dapat diverifikasi oleh operator* |
| *KF06* | *R09* | *Perangkat lunak dapat menampilkan daftar laporan yang telah diverifikasi setelah memilih fitur CleanIt* |
| *KF07* | *R09* | *Perangkat lunak dapat menampilkan antarmuka yang berisi informasi lengkap (lokasi, waktu, sumber, bukti) mengenai laporan yang dipilih pengguna pada fitur CleanIt* |
| *KF08* | *R06* | *Perangkat lunak memiliki terhubung dengan database untuk menyimpan informasi laporan serta object storage foto/video bukti yang dilampirkan* |
| *KF09* |  | *Perangkat lunak memiliki fitur untuk terhubung dengan kamera device dan mengambil foto yang disertai watermark dan timestamp* |
| *KF10* | *R11* | *Perangkat lunak dapat menampilkan antarmuka pembuatan laporan bukti pembersihan* |
| *KF11* | *R15* | *Perangkat lunak dapat menampilkan antarmuka daftar penyelesaian pada database sehingga dapat diverifikasi oleh operator* |
| *KF12* | *R16* | *Perangkat lunak memiliki sistem poin yang dapat ditukarkan dengan reward* |
| *KF13* | *R17* | *Perangkat lunak memiliki terhubung dengan database yang menyimpan jumlah poin pengguna serta jumlah persedian reward yang tersedia* |
| *KF14* | *R17* | *Perangkat lunak memiliki antarmuka penukaran reward yang menampilkan jumlah poin pengguna dan reward yang tersedia untuk ditukarkan* |
